...
class Strategy(models.Model):
    virtual_depo = models.IntegerField(null=True, blank=True)
    point_real = models.IntegerField(null=True, blank=True)
    point_virtual = models.IntegerField(null=True, blank=True)
    percent_real = models.FloatField(null=True, blank=True)
    percent_virtual = models.FloatField(null=True, blank=True)
    depo_year = models.IntegerField(null=True, blank=True)
    percent_year = models.FloatField(null=True, blank=True)
    years_year = models.IntegerField(null=True, blank=True)
    months_year = models.IntegerField(null=True, blank=True)
    days_year = models.IntegerField(null=True, blank=True)
