...
def createWindow():
    new_root = Tk()     # Tk() - new independent window
                        # Toplevel() - new window 'on top' of other window
    root.destroy()      # close out of old window
...
# ----------- OPEN NEW WINDOW -----------
Button(root, text='open new window', command=createWindow).pack()
